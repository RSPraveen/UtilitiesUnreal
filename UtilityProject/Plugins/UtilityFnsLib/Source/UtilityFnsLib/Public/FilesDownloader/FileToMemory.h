...
#include "BaseFiles.h"
#include "FileToMemory.generated.h"

/**
* Possible results from a download request
*/
UENUM(BlueprintType, Category = "File To Memory ")
 ...
 */
UCLASS(BlueprintType, Category = "Runtime Files |Memory")
class UTILITYFNSLIB_API UFileToMemory : public UBaseFiles
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	 //UFUNCTION(BlueprintCallable, Category = "Runtime Files |Memory")
	static UFileToMemory* DownloadFileToMemory(const FString& URL, float Timeout, const FString& ContentType, bool bForceByPayload, const FOnDownloadProgress& OnProgress, const FOnFileToMemoryDownloadComplete& OnComplete);
	 ...
	 * @param OnComplete Delegate for broadcasting the completion of the download
	 */
	static UFileToMemory* DownloadFileToMemory(const FString& URL, float Timeout, const FString& ContentType, bool bForceByPayload, const FOnDownloadProgressNative& OnProgress, const FOnFileToMemoryDownloadCompleteNative& OnComplete);
	 ...
	 */
	 //UFUNCTION(BlueprintCallable, Category = "Runtime Files |Memory")
	static UFileToMemory* DownloadFileToMemoryPerChunk(const FString& URL, float Timeout, const FString& ContentType, int32 MaxChunkSize, const FOnDownloadProgress& OnProgress, const FOnFileToMemoryChunkDownloadComplete& OnChunkDownloadComplete, const FOnFileToMemoryAllChunksDownloadComplete& OnAllChunksDownloadComplete);
