 ...
 */
UCLASS(BlueprintType, Category = "Runtime Files ")
class UTILITYFNSLIB_API UBaseFiles : public UObject
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	 //UFUNCTION(BlueprintCallable, Category = "Runtime Files |Main")
	 ...
	 */
	 //UFUNCTION(BlueprintCallable, Category = "Runtime Files |Utilities")
...
protected:
	...
	/** Internal  */
	TSharedPtr<class FRuntimeChunk> RuntimeChunkPtr;
